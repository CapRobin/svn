 ...
 * @Version v1.0
 */
public class MainActivity_t extends BaseActivity implements OnClickListener {
...
//		gdBut.setOnClickListener(this);
		...
		joke.setOnClickIntent(new MyImageView.OnViewClick() {
			...
			@Override
			public void onClick() {
				Toast.makeText(MainActivity_t.this, "clicked", 100).show();
			}
		});
...
//		switch (v.getId()) {
//		case R.id.ghBut:
//			startActivity(new Intent(MainActivity_t.this, MainActivity_t.class));
//			showToast("点击_01");
//			break;
//		case R.id.qgBut:
//			startActivity(new Intent(MainActivity_t.this, RegisterActivity.class));
//			showToast("点击_02");
//			break;
//		case R.id.fbBut:
