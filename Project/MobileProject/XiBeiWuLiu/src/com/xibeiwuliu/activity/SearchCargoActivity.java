 ...
 * 
 * @Name：SearchCargoActivity.java
 * @Describe：搜索货源
 * @Author: yfr5734@gmail.com
 * @Date：2014年5月12日 上午9:31:05
 * @Version v1.0 *
 * 
 */
public class SearchCargoActivity extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setAbContentView(R.layout.search_cargo);
	...
	public void onClick(View v) {
		...
		case R.id.searchBut:
			...
			if (TextUtils.isEmpty(startAddress) && TextUtils.isEmpty(endAddress)) {
				Toast.makeText(SearchCargoActivity.this, "请先选择出发地和目的地！", 5).show();
			} else if (TextUtils.isEmpty(startAddress)) {
				Toast.makeText(SearchCargoActivity.this, "请先选择出发地！", 5).show();
			} else if (TextUtils.isEmpty(endAddress)) {
				Toast.makeText(SearchCargoActivity.this, "请先选择目的地！", 5).show();
			} else {
				Toast.makeText(SearchCargoActivity.this, "出发地为：" + myView.getStartAddress() + "\n目的地为：" + myView.getEndAddress(), 5).show();
			}
			break;
