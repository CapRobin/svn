...
//	private String getMsg = "选择城市";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setAbContentView(R.layout.cargo_location_view);
	...
	public void onClick(View v) {
		...
		case R.id.shiBtn:
			if (csNameId > 0) {
				...
				Toast.makeText(PublishCargoActivity.this, "请先选择省份！", 5).show();
			}
			break;
		case R.id.qxBtn:
			if (qxNameId > 0) {
				...
				Toast.makeText(PublishCargoActivity.this, "请先选择城市！", 5).show();
			}
			break;
