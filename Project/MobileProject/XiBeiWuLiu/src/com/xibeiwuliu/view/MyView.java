...
/**
 * Created by IntelliJ IDEA. User: zhUser Date: 13-1-24 Time: 下午6:53
 */
public class MyView extends LinearLayout implements OnClickListener {
	...
	public MyView(Context context, AttributeSet attrs) {
		...
		inflater.inflate(R.layout.base_location_view, this);
		// imageView=(ImageView) findViewById(R.id.imageView1);
		// textView=(TextView)findViewById(R.id.textView1);
		daoArea = SqliteDaoArea.getInstance(context);
	...
	public void onClick(View v) {
		...
		case R.id.shiBtn:
			if (csNameId > 0) {
				...
				Toast.makeText(mContext, "请先选择省份！", 5).show();
			}
			break;
		case R.id.qxBtn:
			if (qxNameId > 0) {
				...
				Toast.makeText(mContext, "请先选择城市！", 5).show();
			}
			break;
	...
	public void showView() {
		...
		MyLocationAdapter locationAdapter = new MyLocationAdapter(mContext, strList);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case 3:
					...
					startAddress = sfNameStr + csNameStr + qxNameStr;
	...
	public void showView2() {
		...
		MyLocationAdapter locationAdapter = new MyLocationAdapter(mContext, strList2);
		...
		gridView2.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case 3:
					...
					endAddress = sfNameStr2 + csNameStr2 + qxNameStr2;
					addressText2.setText(endAddress);
					strList = null;
					break;
				}
			}
	...
	public static void setStartAddress() {
		startAddress = null;
	}

	public static void setEndAddress() {
		endAddress = null;
	}
}