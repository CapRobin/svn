 ...
 * @Name：YiDongJieSuanActivity.java 
 * @Describe：移动结算
 * @Author Administrator  yfr5734@gmail.com
 * @Date：2013-11-13 下午12:48:20
 * @Version v1.0
 */
public class YiDongJieSuanActivity extends AbActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setAbContentView(R.layout.ydjs);
