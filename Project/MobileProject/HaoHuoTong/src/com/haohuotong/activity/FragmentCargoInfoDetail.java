 ...
 * @version v1.0
 */
public class FragmentCargoInfoDetail extends AbActivity implements OnClickListener {
...
//		getPhoneList(entitySet.getMsg_Tel());
	...
	private void getData() {
		...
		setDdriverCarParameterList("Add_ID", carInfoId+"");
		...
		item.listener = new AbTaskListener() {
			...
			public void update() {
				...
				if (cargoInfo != null) {
					startActivity(new Intent(FragmentCargoInfoDetail.this, MainActivity.class));
			...
			public void get() {
				try {
					cargoInfo = PublicInfoWeb.cargoInfoDetail("I_A007", configurationParameter);
...
//		mAbTitleBar.setTitleLayoutBackground(R.drawable.top_bg);
		...
		about.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(FragmentCargoInfoDetail.this, ConsultActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case 0:
			if (application.isLogin) {
				Toast.makeText(FragmentCargoInfoDetail.this, "该模块正在开发中，请稍后...", 5).show();
			}
			break;
		case 1:
			...
			if (application.isLogin) {
				if (phoneSize > 0) {
					...
					Toast.makeText(FragmentCargoInfoDetail.this, "该订单暂时没有联系电话！", 5).show();
				}
			}
			break;
		}
...
//			getData();
			if (application.isLogin) {
				...
				Toast.makeText(FragmentCargoInfoDetail.this, "登录后才能查看联系方式！", 5).show();
				startActivityForResult(new Intent(FragmentCargoInfoDetail.this, LoginActivity.class), SHOWPHONE);
			}
			break;
...
//				Toast.makeText(FragmentCargoInfoDetail.this, "该模块正在开发中，请稍后...", 5).show();
//			} else {
//				Toast.makeText(FragmentCargoInfoDetail.this, "登录后才能添加好友！", 5).show();
//				startActivityForResult(new Intent(FragmentCargoInfoDetail.this, LoginActivity.class), ADDFRIENDINTENT);
//			}
			break;
		case R.id.shareInfo:
			startActivity(new Intent(FragmentCargoInfoDetail.this, ContactListActivity.class));
			break;
		case R.id.myFriendBut:
			
//			Toast.makeText(CommonalityInfoDetailActivity.this, "我的好友列表", 5).show();
			if (!application.isLogin) {
				Toast.makeText(FragmentCargoInfoDetail.this, "请先登录！", 5).show();
				return;
			}
			if(application.userInfo.getUserType()!=1){
				Toast.makeText(FragmentCargoInfoDetail.this, "司机才能竞价！", 5).show();
				return;
			}
			intent.putExtra("cargoInfoId", carInfoId);
			intent.setClass(FragmentCargoInfoDetail.this, AuctionListActivity.class);
			startActivity(intent);
//			showMyDialog();
			break;
		}
		...
		AlertDialog dialog = new AlertDialog.Builder(context).setTitle(title)
				...
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Intent intent = new Intent(FragmentCargoInfoDetail.this,AddFriendsActivity.class);
						intent.putExtra("info_AddErID", cargoInfo.getInfo_AddErID());
						intent.putExtra("info_LPR_ID", cargoInfo.getInfo_LPR_ID());
						startActivity(intent);
						dialog.dismiss();
					}
				})
