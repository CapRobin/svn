...
public class Detail extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String ItemId=bunde.getString("ID");
		String msg_type=bunde.getString("msg_type");
		String msg_content=bunde.getString("msg_content");
		String msg_tel=bunde.getString("msg_tel");*/
		//接收参数(通过putExtra）
		...
		//----------------------------------------		
		//提取信息内容中的电话
		Pattern pTel =  Pattern.compile("((1[0-9]{10,})|(\\d{3,4}-\\d{7,8})|(\\d{7,}))");/*把1开头11位及以上的数字，及联系电话都匹配出来*/
	...
	protected void ShowTelMenuDlg() {
		...
		.setSingleChoiceItems(arrayTel, 0, new DialogInterface.OnClickListener() {
	        ...
	        public void onClick(DialogInterface dialog, int which) {
	        	...
	        	//Toast.makeText(Detail.this, strTel, Toast.LENGTH_SHORT).show();
	        	//验证电话
