...
public class BrowserAdapter extends EndlessAdapter {
    ...
    public BrowserAdapter(Context context, String city, String keywords,
            InfoEntity.Type type) {
        super(context, new EntityArrayAdapter(context, -1,
    ...
    public static class EntityArrayAdapter extends ArrayAdapter<Entity> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.msg_content = (TextView) convertView
                        .findViewById(R.id.msg_content);
                holder.msg_date = (TextView) convertView
