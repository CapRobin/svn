...
package com.net56888.logistics.downloads;
...
public class Constants {
    ...
    public static final String TAG = "jru_logistics_Download";
    ...
    public static final String ACTION_RETRY = "jru_logistics.intent.action.DOWNLOAD_WAKEUP";

    /** the intent that gets sent when clicking a successful download */
    public static final String ACTION_OPEN = "jru_logistics.intent.action.DOWNLOAD_OPEN";

    /** the intent that gets sent when clicking an incomplete/failed download  */
    public static final String ACTION_LIST = "jru_logistics.intent.action.DOWNLOAD_LIST";

    /** the intent that gets sent when deleting the notification of a completed download */
    public static final String ACTION_HIDE = "jru_logistics.intent.action.DOWNLOAD_HIDE";

    /** The intent that gets sent when start the service */
    public static final String ACTION_START_DOWNLAD_SERVICE = "jru_logistics.intent.action.START_DOWNLOAD_SERVICE";    
    ...
    public static final String DEFAULT_DL_SUBDIR = "/jru_logistics/Download";
    ...
    public static final String DEFAULT_USER_AGENT = "JruDownload";
