...
public final class Downloads {
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "jru_logistics.permission.ACCESS_DOWNLOAD_MANAGER";
    ...
    public static final String PERMISSION_ACCESS_ADVANCED =
            "jru_logistics.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";
    ...
    public static final String PERMISSION_SEND_INTENTS =
            "jru_logistics.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";
    ...
    public static final Uri CONTENT_URI =
        Uri.parse("content://jrulogisticsdownloads/download");
    ...
    public static final String ACTION_DOWNLOAD_COMPLETED =
            "jru_logistics.intent.action.DOWNLOAD_COMPLETED";
    ...
    public static final String ACTION_NOTIFICATION_CLICKED =
            "jru_logistics.intent.action.DOWNLOAD_NOTIFICATION_CLICKED";
    ...
    public static final String COLUMN_APP_GUID = "guid";
    ...
    public static final class Impl implements BaseColumns {
         ...
         * The permission to access the download manager
         */
        public static final String PERMISSION_ACCESS = "jru.permission.ACCESS_DOWNLOAD_MANAGER";
        ...
        public static final String PERMISSION_SEE_ALL_EXTERNAL =
                "jru_logistics.permission.SEE_ALL_EXTERNAL";
        ...
        /**
         * Broadcast Action: this is sent by the download manager to the app
         * that had initiated a download when that downloCOLUMN_URIad completes. The
         * download's content: uri is specified in the intent's data.
         */
        public static final String ACTION_DOWNLOAD_COMPLETED =
                "jru_logistics.intent.action.DOWNLOAD_COMPLETED";
