...
public final class DownloadProvider extends ContentProvider {
    ...
    private static final String DOWNLOAD_LIST_TYPE = "vnd.jrulogisticsdownloads.cursor.dir/download";
    /** MIME type for an individual download */
    private static final String DOWNLOAD_TYPE = "vnd.jrulogisticsdownloads.cursor.item/download";
    ...
    static {
        sURIMatcher.addURI("jrulogisticsdownloads", "download", DOWNLOADS);
        sURIMatcher.addURI("jrulogisticsdownloads", "download/#", DOWNLOADS_ID);
    }
    ...
    private void createTable(SQLiteDatabase db) {
        try {
            db.execSQL("CREATE TABLE " + DB_TABLE + "(" +
                    ...
                    Downloads.Impl.COLUMN_APP_GUID + " TEXT, " +
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        copyString(Downloads.Impl.COLUMN_APP_GUID, values, filteredValues);
...
*/
    ...
    public int delete(final Uri uri, final String where,
    	...
    	Log.d(Constants.TAG, "deleting URI: " + uri);    	
